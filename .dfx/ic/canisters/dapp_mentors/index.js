...
import { idlFactory } from './dapp_mentors.did.js';
export { idlFactory } from './dapp_mentors.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAPP_MENTORS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dapp_mentors.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dapp_mentors canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dapp_mentors.did.js")._SERVICE>}
 */
export const dapp_mentors = createActor(canisterId);
